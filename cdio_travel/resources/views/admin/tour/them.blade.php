                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="tentour" placeholder="Nhập tên tour" />
                                        </div>
                                        <div class="form-group">
                                            <label>Mã miền</label>
                                            <select class="form-control" name="id_mien">
                                                ...
                                                <option value="{{$m_t-> id}}">{{$m_t-> ten_mien}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="thoigian_tour" placeholder="Nhập thời gian tour" />
                                        </div>
                                        <div class="form-group">
                                            <label>Điểm khởi hành</label>
                                            <input class="form-control" name="diem_khoihanh" placeholder="Nhập nơi khỏi hành" />
                                        </div>
                                        <div class="form-group">
                                            <label>Điểm đến</label>
                                            <input class="form-control" name="diem_den" placeholder="Nhập thời nơi đến" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    {{-- <div class="col-lg-6"> --}}
                                        <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control ckeditor" name="noidung" rows="3"placeholder="Nhập nội dung"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Số lượng cho phép</label>
                                                    <input class="form-control" name="soluong_nguoi" placeholder="Nhập số lượng người" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Giá gốc</label>
                                                    <input class="form-control" name="gia" placeholder="15000000 VND" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Giá khuyến mãi</label>
                                                    <input class="form-control" name="gia_km" placeholder="9000000 VND" />
                                                </div>
                                                <div class="form-group">
