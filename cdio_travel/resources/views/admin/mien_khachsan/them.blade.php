    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10" style="padding-bottom:120px">
                ...
                <form action="admin/mien_khachsan/them" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea class="form-control ckeditor" name="mota" rows="3"placeholder="Nhập mô tả"></textarea>
                    </div>
